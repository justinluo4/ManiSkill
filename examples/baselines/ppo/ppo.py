...
if __name__ == "__main__":
    ...
    if args.capture_video:
        ...
        eval_envs = RecordEpisode(eval_envs, info_on_video=True, output_dir=eval_output_dir, save_trajectory=args.evaluate, trajectory_name="trajectory", max_steps_per_video=args.num_eval_steps, video_fps=30)
